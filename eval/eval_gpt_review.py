...
def get_eval(sys_prompt, user_prompt: str, max_tokens: int):
    ...
    # set openai organization id if given; use default otherwise
...
if __name__ == "__main__":
    ...
    for ab in range(2 if args.bidirectional else 1):
        for i in question_idx_list:
            ...
            if ab == 0:
                ...
                ans1 = answer2_jsons[i]["text"]
                ans2 = answer1_jsons[i]["text"]
                answer1_id = answer2_jsons[i]["answer_id"]
                answer2_id = answer1_jsons[i]["answer_id"]
